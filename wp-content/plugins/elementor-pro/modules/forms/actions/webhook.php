...
class Webhook extends Action_Base {
	...
	public function print_response( $response, $record ) {
		return "aaa";
	}
	...
	public function register_settings_section( $widget ) {
		...
		$widget->add_control(
			...
			[
                ...
                $widget->add_control(
                        'webhooks_respone_data',
                        [
                                'label' => esc_html__( 'Respone Data', 'elementor-pro' ),
                                'type' => Controls_Manager::TEXT,
                                'placeholder' => esc_html__( '---', 'elementor-pro' ),
                                'render_type' => 'none',
                                'dynamic' => [
                                        'active' => true,
                                ],
	...
	public function __construct() {
		add_action('elementor_pro/forms/webhooks/response', [ $this, 'print_response' ], 10, 2 );
	}
}
